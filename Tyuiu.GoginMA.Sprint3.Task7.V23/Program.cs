...
using Tyuiu.GoginMA.Sprint3.Task7.V23.Lib;

namespace Tyuiu.GoginMA.Sprint3.Task7.V23
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* f(x) на заданном диапазоне [-5; 5] с шагом 1. При делении на 0         *");
